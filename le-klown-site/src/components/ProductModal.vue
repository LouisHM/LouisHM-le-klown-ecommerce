          ...
          >
            ...
            <div class="p-3 md:p-0">
              <div class="relative aspect-[4/3] md:aspect-square rounded-xl overflow-hidden bg-black/10">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 -scale-x-100" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M12.293 15.707a1 1 0 01-1.414 0L5.586 10l5.293-5.707a1 1 0 111.414 1.414L8.414 10l3.879 4.293a1 1 0 010 1.414z" clip-rule="evenodd" />
                  </svg>
                </button>
            ...
            <div class="p-3 md:p-0 pr-3 md:pr-0">
              ...
              <div class="mt-4 space-y-3">
                ...
                <button
                  ...
                  class="w-full bg-primary text-dark md:text-light py-2.5 md:py-3 rounded-lg font-semibold
