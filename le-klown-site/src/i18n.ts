...
const messages = {
  en: {
    ...
    admin: {
      ...
      optionHint: 'Add options (e.g. Size, Color) to create variants.',
      optionLabel: 'Display label',
      optionCode: 'Internal code',
      optionRequired: 'Option required',
      optionMulti: 'Allow multiple values',
      optionValues: 'Values',
      addValue: 'Add value',
      ...
      variants: 'Variants',
      generateVariants: 'Generate all combinations',
      addVariant: 'Add variant',
      variantHint: 'Add at least one variant with its stock level.',
      optionNeedsValue: '{option} needs at least one value.',
      variantNeedsOne: 'Add at least one variant.',
      variantStockPositive: 'Variant stock must be zero or greater.',
      variantMissingOption: 'Each variant must define “{option}”.',
      variantDuplicate: 'Two variants share the same combination.',
      totalStock: 'Total stock',
      generatingSkus: 'Generating SKUs…',
      uploadImageLabel: 'Upload an image',
      uploadImageHelp: 'JPG/PNG, stored in bucket {bucket}.',
  ...
  fr: {
    ...
    admin: {
      ...
      optionHint: 'Ajoute des options (ex : Taille, Couleur) pour créer des variantes.',
      optionLabel: 'Libellé affiché',
      optionCode: 'Code interne',
      optionRequired: 'Option obligatoire',
      optionMulti: 'Plusieurs valeurs autorisées',
      optionValues: 'Valeurs',
      addValue: 'Ajouter une valeur',
      noValuesYet: 'Aucune valeur définie.',
      valueLabel: 'Libellé',
      valueCode: 'Code',
      removeOption: "Supprimer l'option",
      variants: 'Variantes',
      generateVariants: 'Générer toutes les combinaisons',
      addVariant: 'Ajouter une variante',
      variantHint: 'Ajoute au moins une variante avec son stock.',
      optionNeedsValue: '{option} doit contenir au moins une valeur.',
      variantNeedsOne: 'Ajoute au moins une variante.',
      variantStockPositive: 'Le stock de chaque variante doit être supérieur ou égal à 0.',
      variantMissingOption: 'Chaque variante doit définir « {option} ».',
      variantDuplicate: 'Deux variantes partagent la même combinaison.',
      totalStock: 'Stock total',
      generatingSkus: 'Génération des SKU…',
      uploadImageLabel: 'Téléverser une image',
      uploadImageHelp: 'Formats JPG/PNG, stockés dans le bucket {bucket}.',
